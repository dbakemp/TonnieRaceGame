...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Advertentieoverzicht</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Advertenties Tonnie's grote racewereld
                    </div>
                    <!-- /.panel-heading -->
                                ...
                                if ($result = $mysqli->query($query))
                                {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<tr>
                                                ...
                                                <td>'.$isActive.'</td>
                                                <td><a href="index.php?page=dashboard&sub=edit&id='.$row["ID"].'">Aanpassen</a> | <a href="index.php?page=dashboard&sub=delete&id='.$row["ID"].'">Verwijderen</a></td>
                                            </tr>';
